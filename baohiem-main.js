...
function responsive(e){$("#header .btn-outline-light").click(function(){_scrollTo(".wap_form");$("#navbarCollapse").collapse('hide');$("html,body").removeClass("active")});$("#navbarCollapse .nav-link").click(function(){e=$(this).attr("data-target");_scrollTo(e);if($(window).width()<992){$("#header .navbar-toggler").click();$("html,body").removeClass("active")}});if($(window).width()<992){$('.navbar-btn').appendTo('.navbar-expand-lg .container');$("#header .navbar-toggler").click(function(){$("html,body").toggleClass("active")});$(".btn_view_more").click(function(){$(".list_check li:hidden:first").show()})}}
function scroll_to_top(){var winscroll=$(window).scrollTop();if($("body").length){if(winscroll>=vw*8.75){$("header").addClass("sticky");$(".back_to_top").fadeIn("fast").addClass("sticky")}else{$("header").removeClass("sticky");$(".back_to_top").fadeOut("fast")}}}
function _scrollTo(hash){if(hash){var nav=$('header').outerHeight(!0);$("html, body").animate({scrollTop:$(hash).offset().top-(nav-1)},500,'linear')}}
function callPopup(url){$.fancybox.open({src:url,type:'inline',opts:{margin:0,padding:0,touch:!1,focus:!1,keyboard:!1,clickContent:!1,clickOutside:!1,clickSlide:!1,autoFocus:!1,smallBtn:!1,toolbar:!1,dblclickContent:!1,dblclickSlide:!1,dblclickOutside:!1,beforeClose:function(){$('.error').tooltip('hide')}}});$('.error').tooltip('hide')}
function scaleCaptcha(){if($('#reCaptchaRD').length){var reCaptchaWidth=240;var containerWidth=$('.box_capcha').width();if(reCaptchaWidth>containerWidth){var captchaScale=containerWidth/reCaptchaWidth;$('#reCaptchaRD').css({'transform':'scale('+captchaScale+')','transform-origin':'left center','relative':'relative','z-index':'2',})}}}
function sliderWeb(){function slick_on_mobile(slider,settings){$(window).on('load resize',function(){if(is_Mobile=='0'){if(slider.hasClass('slick-initialized')){slider.slick('unslick')}
    return}
    if(!slider.hasClass('slick-initialized')){return slider.slick(settings)}})};if($('.ql_slider').length){var count_item=$('.ql_slider .item').length;if(count_item>4){$('.ql_slider').slick({centerPadding:0,infinite:!0,slidesToShow:4,slidesToScroll:1,centerMode:!0,arrows:!0,dots:!0,autoplay:!0,autoplaySpeed:10000,prevArrow:'<div class="slick-prev"><i class="fas fa-chevron-left"></i></div>',nextArrow:'<div class="slick-next"><i class="fas fa-chevron-right"></i></div>',responsive:[{breakpoint:992,settings:{slidesToShow:1,slidesToScroll:1,}}]}).fadeTo("slow",1);$('.ql_slider').slick('slickGoTo',1)}
    if(count_item==4){$('.ql_slider').addClass('ql_no_slider').addClass('ql_no_slider_center')}else{$('.ql_slider').addClass('ql_no_slider')}}
    if($(".video_slider").length){var count_item_video=$(".video_slider .item").length;if(count_item_video>2){$('.video_slider').slick({infinite:!1,slidesToShow:3,slidesToScroll:1,autoplay:!1,arrows:!0,prevArrow:'<div class="slick-prev"><i class="fas fa-chevron-left"></i></div>',nextArrow:'<div class="slick-next"><i class="fas fa-chevron-right"></i></div>',dots:!0,fade:!1,responsive:[{breakpoint:992,settings:{slidesToShow:1,slidesToScroll:1,}}],}).fadeTo("slow",1)}else{$(".video_slider .item").addClass('no-slider')}}
    var st_1=undefined;if(is_Mobile=='1'){slick_on_mobile($('.procedure_nav'),{slidesToShow:1,slidesToScroll:1,dots:!1,arrows:!1,centerMode:!0,focusOnSelect:!0,fade:!0,autoplay:!0,autoplaySpeed:4000,});st_1={asNavFor:'.procedure_nav',autoplaySpeed:4000,infinite:!0,slidesToShow:1,slidesToScroll:1,autoplay:!0,arrows:!0,prevArrow:'<div class="slick-prev"><i class="fas fa-chevron-left"></i></div>',nextArrow:'<div class="slick-next"><i class="fas fa-chevron-right"></i></div>',dotsClass:'pagination procedure_paging list-unstyled mb-0',dots:!0,fade:!0,customPaging:function(slider,i){return'<div class="tu">'+(i+1)+'</div>'+'<div class="line"></div>'+'<div class="mau">'+slider.slideCount+'</div>'}}}else{st_1={autoplaySpeed:4000,infinite:!0,slidesToShow:1,slidesToScroll:1,autoplay:!0,arrows:!0,prevArrow:'<div class="slick-prev"><i class="fas fa-chevron-up"></i></div>',nextArrow:'<div class="slick-next"><i class="fas fa-chevron-down"></i></div>',dotsClass:'pagination procedure_paging list-unstyled mb-0',dots:!0,fade:!0,customPaging:function(slider,i){return'<div class="tu">'+(i+1)+'</div>'+'<div class="line"></div>'+'<div class="mau">'+slider.slideCount+'</div>'}}}
    slick_on_mobile($('.slick-mobile'),{centerPadding:0,infinite:!1,slidesToShow:1,slidesToScroll:1,centerMode:!0,arrows:!0,dots:!0,fade:!1,autoplay:!1,autoplaySpeed:10000,prevArrow:'<div class="slick-prev"><i class="fas fa-chevron-left"></i></div>',nextArrow:'<div class="slick-next"><i class="fas fa-chevron-right"></i></div>',});slick_on_mobile($('.rules_dt'),{centerPadding:0,infinite:!1,slidesToShow:2,slidesToScroll:1,centerMode:!1,arrows:!0,dots:!0,fade:!1,autoplay:!1,autoplaySpeed:10000,prevArrow:'<div class="slick-prev"><i class="fas fa-chevron-left"></i></div>',nextArrow:'<div class="slick-next"><i class="fas fa-chevron-right"></i></div>',});if($(".procedure_for").length){$('.procedure_for').slick(st_1).fadeTo("slow",1)}
    $('.procedure_btn.nav-tabs .nav-link').on('shown.bs.tab',function(e){$('.procedure_content .tab-pane.active .procedure_for').slick('refresh').slick('slickGoTo',0);$('.procedure_content .tab-pane.active .procedure_nav').slick('refresh').slick('slickGoTo',0)})}
function to_top(){$('html,body').animate({scrollTop:0},800)}
function backtop(){$(window).scroll(function(){if($(window).scrollTop()>100){$('.back_top').addClass('back_hide')}else{$('.back_top').removeClass('back_hide')}});$('.back_top').click(function(){to_top()})}
function checkBirthday(){var birthday=$('#birthday').val();if(birthday==""){return!0}else{var regex=new RegExp("d|m|y");if(regex.test(birthday)){$('#birthday').val('')
    return!0}else{var list=birthday.split("/");var currentYear=new Date().getFullYear();if(list[2]>=currentYear){$('#birthday').val('')
    return!0}
    return!1}}}
function checkPhone(){var phone=$('#phone').val();var list=phone.split("");if(list[0]==0||(list[0]==8&&list[1]==4)){return!1}else{$('#phone').val('');return!0}}
function checkValidate(){$('#name_city').val($('#city option:selected').text().toLowerCase());$("#frm-dang-ky-tu-van").validate({rules:{name:{required:!0},phone:{required:checkPhone(),number:!0,minlength:10,maxlength:12},email:{required:!0,email:!0},city:{required:!0},mucdich:{required:!0},birthday:{required:checkBirthday()},thunhap:{required:!1},},messages:{name:{required:"Vui lòng nhập họ & tên!"},phone:{required:"Vui lòng nhập điện thoại!",number:"Vui lòng nhập đúng điện thoại!",minlength:"Vui lòng nhập đúng điện thoại!",maxlength:"Vui lòng nhập đúng điện thoại!"},email:{required:"Vui lòng nhập email!",email:"Vui lòng nhập đúng email!"},city:{required:"Vui lòng chọn khu vực sinh sống!"},mucdich:{required:"Vui lòng chọn mục đích mua bảo hiểm!"},birthday:{required:"Vui lòng nhập ngày tháng năm sinh!"},},submitHandler:function(form){$('#loader').show();var formData=new FormData(form);$.ajax({type:"POST",url:base_url+"checkCaptcha",data:formData,dataType:'json',mimeType:"multipart/form-data",contentType:!1,cache:!1,processData:!1,success:function(data){if(data.status){sendDangky(formData)}else{$('#loader').fadeOut();$('#contentThongbao').html(data.mess);callPopup('#popupThongbao');$('#html-reCaptchaRD').html('<div id="reCaptchaRD" class="g-recaptcha"></div>');widgetID=grecaptcha.render(document.getElementById('reCaptchaRD'),{'sitekey':'6Leo-rEZAAAAANBcxNKi-jt-_HJxd7WyNinPOAva'});grecaptcha.reset(widgetID);scaleCaptcha()}}});return!1}})}
function sendDangky(formData){$.ajax({type:"POST",url:base_url+"sendDangky",data:formData,dataType:'json',mimeType:"multipart/form-data",contentType:!1,cache:!1,processData:!1,success:function(data){$('#loader').fadeOut();if(data.status){location.href=data.redirectUrl}else{$('#contentThongbao').html(data.mess);callPopup('#popupThongbao');$('#html-reCaptchaRD').html('<div id="reCaptchaRD" class="g-recaptcha"></div>');widgetID=grecaptcha.render(document.getElementById('reCaptchaRD'),{'sitekey':'6Leo-rEZAAAAANBcxNKi-jt-_HJxd7WyNinPOAva'});grecaptcha.reset(widgetID);scaleCaptcha()}}})}
function download(id){$.ajax({type:"POST",url:base_url+"downLoads",data:{'id':id,token_name:token_value},dataType:'json',success:function(data){return}})}
...
$(window).load(function () {
    $(window).scrollspy({
        target: '#navbarCollapse .navbar-nav',
        offset: ($('header').outerHeight(true) + 2),
    });
    $(window).on('activate.bs.scrollspy', function (e, obj) {
        window.history.pushState({}, '', obj.relatedTarget);
    })
});
...
$(document).ready(function (e) {
    ...
    if (is_Mobile == '1') {
        $(window).scroll(function (e) {
            ...
            var isPositionEl = $('.div_fixedElement').offset();
            var current = $(this).scrollTop() + 5 * vw;
            if (current > isPositionEl.top) {
                $el.css({'position': 'fixed', 'top': '5rem', 'box-shadow': '0px 4px 0px 2px rgba(235, 241, 244,  .5)'});
            }
            if (current < isPositionEl.top) {
                $el.css({'position': 'relative', 'top': '0px', 'box-shadow': 'none'});
            }
        });
    }
    $('#city').select2({
        ...
        "language": {
            "noResults": function(){
                return "<span class='no-results'>Không tìm thấy kết quả!</span>";
            }
        },
    ...
    $('#city').on('select2:opening', function (e) {
        var city = $('#city').val();
        if(city ==''){
            $('.label-city').addClass('city-fix-top')
        }else{
            $('.label-city').removeClass('city-fix-top')
        }

    });
    $('#city').on('select2:closing', function (e) {
        var city = $('#city').val();
        if(city !=''){
            $('.label-city').addClass('city-fix-top')
        }else{
    ...
    document.querySelector("#city").parentElement.addEventListener("click", function(){
    ...
    $('input#birthday').bind('input propertychange change paste', function() {
        var _this = $(this);
        var birthday = _this.val();
        var regex = new RegExp("d|m|y");

        if(birthday == ""){
            _this.addClass('inputting');
        }else{
            if( !regex.test(birthday)) {
                if(_this.hasClass('inputting')){
                    _this.removeClass('inputting');
                }
            }else{
                if(!_this.hasClass('inputting')){
                    _this.addClass('inputting');
            ...
            4713: function (e, t, i) {
                ...
                function d(e, t, i) {
                    var a, r, o = this, s = this.dependencyLib, l = this.maskset, c = this.opts, d = this.el,
                        p = l.maskToken, h = t ? i : 0, v = t ? t.slice() : [0], m = [], g = !1,
                        k = t ? t.join("") : "";
                        ...
                        function s(r, o, u) {
                            ...
                            if (h === e && void 0 === r.matches) {
                                ...
                                if (r.isGroup && u !== r) {
                                    ...
                                    var S, w = r, _ = [], M = m.slice(), O = o.length, T = !1,
